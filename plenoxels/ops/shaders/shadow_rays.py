...
def pointlight_shadow_shader(rb: RenderBuffer, rays: Rays, tracer,
    ...
    Args:
        ...
        tracer (BaseTracer): The neural field.
    ...
    with torch.no_grad():
        ...
        light_o = torch.tensor([[point_light]]).to(rays.origins.device)

        shadow_ray_o = rb.xyz + 0.01 * rb.normal
        shadow_ray_d = torch.zeros_like(rb.xyz).normal_(0.0, 0.01) + light_o - shadow_ray_o
        ...
        rb.shadow = tracer.tracer(tracer.nef, rays=shadow_rays).hit
